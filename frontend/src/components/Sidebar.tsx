        ...
        <>
            ...
            >
                <Link
                    to="/"
                    onClick={onNavigate}
                    className="flex items-center gap-2.5 rounded-xl min-w-0"
                >
                    <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-xl bg-blue-600 flex items-center justify-center text-white font-black tracking-tighter text-sm shadow-md shadow-blue-500/20">
                            P360
                        </div>
                        {!collapsed && (
                ...
                <button
                    ...
                    className={`hidden md:flex p-1.5 text-gray-400 rounded-full transition-all hover:text-gray-700 hover:bg-black/[0.05] active:scale-90 ${
                        collapsed
                ...
                <button
                    ...
                    className="md:hidden p-1.5 text-gray-400 rounded-full hover:text-gray-700 hover:bg-black/[0.05]"
                >
                    <X className="w-5 h-5" />
                </button>
            </div>
            ...
            <div
                className={`shrink-0 border-t border-black/[0.06] p-3 space-y-2 ${
                    collapsed ? "flex flex-col items-center" : ""
                }`}
            >
                <div
                    className={`flex items-center gap-2.5 rounded-[12px] p-1.5 ${
                        collapsed ? "flex-col" : ""
                    }`}
                >
                ...
                <button
                    ...
                    title="Logout"
                    className={`flex items-center gap-2.5 rounded-[12px] text-[13px] font-semibold text-red-600 transition-all hover:bg-red-50 active:scale-[0.97] ${
                        collapsed
        ...
        <>
            ...
            <div className="md:hidden sticky top-0 z-40 flex items-center gap-3 h-14 px-4 bg-white/80 backdrop-blur-xl border-b border-black/[0.06]">
                <button
                    ...
                    className="p-2 -ml-2 text-gray-500 rounded-full hover:bg-black/[0.05]"
                >
